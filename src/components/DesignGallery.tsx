...
const NOTES: Record<FriendKind, string> = {
  ...
  kiki: 'קיקי (20) — עשרים בבלוק 5×4 (שתי עשרות!), אדום-עמוק, בת עם כתר. 🎉',
  romi: 'רומי (21) — עשרים-ואחת בשורות 4·4·5·4·4, ורוד-פטל, עם כובע מצחייה.',
  nini: 'ניני (22) — עשרים-ושתיים בשורות 4·5·4·5·4, כתום-שרוף, בת עם פפיון.',
  pupi: 'פופי (23) — עשרים-ושלוש בשורות 4·5·5·5·4, חרדל, עם כובע פרופלור.',
  tuti: 'תותי (24) — עשרים-וארבע ביהלום 4·5·6·5·4, ירוק-זית, בת עם פרח. 💎',
  mishi: 'מישי (25) — עשרים-וחמש בריבוע מושלם 5×5, אזמרגד, עם משקפיים. 🟩',
  buzi: 'בוזי (26) — עשרים-ושש בשורות 5·5·6·5·5, טורקיז, עם כוכב. ⭐',
  dagi: 'דגי (27) — עשרים-ושבע בשורות 5·6·5·6·5, כחול, עם כובע מסיבה. 🎉',
  lala: 'לאלה (28) — עשרים-ושמונה בשורות 5·6·6·6·5, סגול, בת עם נזר. 👑',
  chumi: 'חומי (29) — עשרים-ותשע בשורות 6·6·5·6·6, מגנטה, עם אוזניות.',
  tsutsi: 'צוצי (30) — שלושים בריבוע ענק 6×5 (שלוש עשרות!), אדום-עמוק, בת עם כתר. הכי גדולה! 🎉',
}
