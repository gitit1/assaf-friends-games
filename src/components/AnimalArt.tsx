  ...
  return (
    <svg className="an-svg" viewBox="0 0 200 210" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        ...
        {/* FUR: roughen the edges of the furry shapes into soft fluff */}
        <filter id="dgFur2" x="-15%" y="-15%" width="130%" height="130%">
          <feTurbulence type="fractalNoise" baseFrequency="0.09 0.12" numOctaves="2" seed="7" result="n" />
          <feDisplacementMap in="SourceGraphic" in2="n" scale="7" xChannelSelector="R" yChannelSelector="G" />
        </filter>
      </defs>
      <g filter="url(#dgSoft)">
        <g transform={t.body} filter="url(#dgFur2)">
          <path d="M150 158 C 180 152 184 124 168 116 C 172 134 158 148 150 154 Z" fill="url(#dgFur)" />
        ...
        <g transform={t.head}>
          ...
          <path d="M100 110 C 96 117 90 116 88 112 M100 110 C 104 117 110 116 112 112" fill="none" stroke="#3a2a1c" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
  ...
  return (
    <svg className="an-svg" viewBox="0 0 200 210" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        ...
        <filter id="ctFur2" x="-15%" y="-15%" width="130%" height="130%">
          <feTurbulence type="fractalNoise" baseFrequency="0.09 0.12" numOctaves="2" seed="4" result="n" />
          <feDisplacementMap in="SourceGraphic" in2="n" scale="7" xChannelSelector="R" yChannelSelector="G" />
        </filter>
      </defs>
      <g filter="url(#ctSoft)">
        <g transform={t.body} filter="url(#ctFur2)">
          <path d="M150 170 C 176 152 180 116 162 110 C 164 134 152 152 146 162 Z" fill="url(#ctFur)" />
        ...
        <g transform={t.head}>
          ...
          <path d="M100 109 C 96 115 91 114 89 110 M100 109 C 104 115 109 114 111 110" fill="none" stroke="#6a6570" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
  ...
  return (
    <svg className="an-svg" viewBox="0 0 200 210" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        ...
        <filter id="rbFur2" x="-15%" y="-15%" width="130%" height="130%">
          <feTurbulence type="fractalNoise" baseFrequency="0.09 0.12" numOctaves="2" seed="2" result="n" />
          <feDisplacementMap in="SourceGraphic" in2="n" scale="7" xChannelSelector="R" yChannelSelector="G" />
        </filter>
      </defs>
      <g filter="url(#rbSoft)">
        <g transform={t.body} filter="url(#rbFur2)">
          <ellipse cx="150" cy="150" rx="16" ry="14" fill="#f4f2f7" />
        ...
        <g transform={t.head}>
          ...
          <path d="M100 110 C 97 115 92 114 90 111 M100 110 C 103 115 108 114 110 111" fill="none" stroke="#a99fb8" strokeWidth="2.3" strokeLinecap="round" strokeLinejoin="round" />
    ...
    <svg className="an-svg" viewBox="0 0 200 210" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <g filter="url(#prSoft)">
        ...
        <g transform={t.head}>
          ...
          <g transform={`translate(100 42) scale(${[0.58, 0.8, 1][stage] ?? 1}) translate(-100 -42)`}>
          ...
          <path d="M88 106 C 94 110 106 110 112 106" fill="none" stroke="#c96a18" strokeWidth="2" strokeLinecap="round" />
        </g>
      </g>
    </svg>
  )
...
export default function AnimalArt({ kind, walking = false, eating = false, stage = 2 }: Props) {
  const Art = SVG[kind] ?? DogSvg
  const stageClass = stage === 0 ? 'stage-cub' : stage === 1 ? 'stage-teen' : 'stage-adult'
  return (
    <div className={`friend-art animal animal-${kind} an-svg-wrap ${stageClass} ${walking ? 'is-walking' : ''} ${eating ? 'is-eating' : ''}`}>
      <Art stage={stage} />
    </div>
  )
}
